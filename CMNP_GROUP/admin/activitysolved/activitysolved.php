    ...
    <table class="table table-bordered" id="table">
        ...
        <?php 
            ...
            <tr>
                ...
                <td><?php echo nl2br($pecah['DESKRIPSI_SOLVED']); ?></td>
                <td><?php echo  ($pecah['TGL_SOLVED']); ?></td>
                <td><?php echo htmlspecialchars($pecah['NM_STATUS']); ?></td>
                <td>
                    <div class="btn-group" role="group">
                        <br><a href="index.php?halaman=ubahactivitysolved&id=<?php echo $pecah['ID_ACTIVITY']; ?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-edit"></i> Ubah</a><br>
                        <br><a href="index.php?halaman=detailactivitysolved&id=<?php echo $pecah['ID_ACTIVITY']; ?>" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-eye-open"></i> Detail</a><br>
                    </div>
                </td>
            </tr>
            <?php 
