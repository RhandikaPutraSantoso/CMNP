...
<?php
$datakategori=array();
$ambil= $koneksi->query("SELECT * FROM SBO_CMNP_KK.KATEGORI");
...
if (isset ($_POST['save']))
{
	...
	if (empty($_POST['ID_KATEGORI']) || !is_numeric($_POST['ID_KATEGORI'])) {
		echo "<div class='alert alert-danger'>Pilih kategori yang valid!</div>";
		exit;
	}
