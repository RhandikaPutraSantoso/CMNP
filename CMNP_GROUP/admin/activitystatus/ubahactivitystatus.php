...
date_default_timezone_set('Asia/Jakarta'); // Atur zona waktu ke Jakarta (WIB)
			...
			<textarea name="deskripsi" class="form-control" id="deskripsi" rows="10"><?php echo $pecah['DESKRIPSI']; ?></textarea>
			</div>
			...
			ID_STATUS='$_POST[ID_STATUS]',TGL_STATUS='$TGL_STATUS'
			...
			echo "<script>location='index.php?halaman=activitystatus';</script>";
			}
			?>
			<?