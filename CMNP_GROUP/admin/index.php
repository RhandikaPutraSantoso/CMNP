...
?>
<?php $ambil=$koneksi->query("SELECT*FROM SBO_CMNP_KK.ADMIN_SAP ");
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand center" href="../User">CMNP</a>    
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a class="active-menu"  href="index.php?halaman=produk"><i class="fa fa-tags fa-fw"></i> Activity SAP</a></li>
                    <li><a class="active-menu"  href="index.php?halaman=activitystatus"><i class="fa fa-tasks fa-fw"></i> Activity Status SAP</a></li>
                    <li><a class="active-menu"  href="index.php?halaman=activitysolved"><i class="fa fa-check-square-o fa-fw"></i> Activity Solved SAP</a></li>
                    <li><a class="active-menu"  href="index.php?halaman=kategori"><i class="fa fa-cogs"></i> Pengaturan</a></li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
               ...
               if (isset($_GET['halaman'])) 
               {
                    ...
                    elseif ($_GET['halaman']=="tambahemail") 
                    {
                        include 'tambahemail.php';
                    }
                    elseif ($_GET['halaman']=="ubahemail") 
                    {
                        include 'ubahemail.php';
                    }
                    elseif ($_GET['halaman']=="hapusemail") 
                    {
                        include 'hapusemail.php';
                    }
                    elseif ($_GET['halaman']=="hapuscompany") 
                    {
                        include 'hapuscompany.php';
                    }
                    elseif ($_GET['halaman']=="tambahcompany") 
                    {
                        include 'tambahcompany.php';
                    }
                    elseif ($_GET['halaman']=="ubahcompany") 
                    {
                        include 'ubahcompany.php';
                    }
