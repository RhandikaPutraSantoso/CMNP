<style type="text/css">
	body{
		background: center / contain no-repeat ,
            #eee 35% url("tema/backgroundKategori.jpg");
	}
	.col-md-3{
		position: relative;
		margin:0 auto;
...
<body>
	<div class="container">
		...
		<h3 style="color:white;background:purple;width:max-content;height:38px;padding:5px;">Kategori : <?php echo $pe["nama_kategori"] ?></h3>
